...
const RateCardPlaceholder = ({ categoryFilter, searchQuery, onRequestQuote }) => {
  ...
  const services = [
    { id: 'basic-website', name: 'Basic Website', category: 'web-development', price: '$350 - $600', description: 'Simple 5-7 page website with responsive design' },
    { id: 'business-website', name: 'Business Website', category: 'web-development', price: '$600 - $1,500', description: 'Professional site with up to 15 pages and custom features' },
    { id: 'logo-design', name: 'Logo Design', category: 'graphic-design', price: '$150 - $450', description: 'Custom logo design with multiple revisions' },
    { id: 'seo-package', name: 'SEO Package', category: 'digital-marketing', price: '$250 - $600/mo', description: 'Keyword research, optimization, and monthly reporting' }
  ];
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center pt-4 border-t border-gray-200 dark:border-gray-700">
                  <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-blue-600">{service.price}</span>
                  <button
                    onClick={() => onRequestQuote(service.id, service.category)}
                    className="px-5 py-2.5 bg-gradient-to-r from-red-600 to-blue-600 text-white rounded-lg text-sm font-medium hover:from-red-700 hover:to-blue-700 transition-all duration-300 flex items-center"
                  >
                    Request Quote
...
const TestimonialCard = ({ isDarkMode }) => (
  <div className={`rounded-xl overflow-hidden shadow-lg ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
    <div className="h-3 bg-gradient-to-r from-red-600 to-blue-600"></div>
    <div className="p-8">
      <div className="flex flex-col items-center">
        <div className="w-16 h-16 mb-6 rounded-full bg-gradient-to-r from-red-100 to-blue-100 dark:from-red-900 dark:to-blue-900 flex items-center justify-center">
...
const RateCardPage = () => {
  ...
  const themeClasses = {
    ...
    button: {
      primary: 'bg-red-600 hover:bg-red-700 text-white transition-colors',
          ...
          <MotionWrapper delay={0.1}>
            <div className="text-center max-w-3xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-12">
                <Link 
                  to="/quote-request" 
                  className="inline-flex items-center px-8 py-3.5 bg-white text-red-600 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 font-medium"
                >
                  Get Custom Quote
                </Link>
          ...
          <MotionWrapper>
            <div className={`rounded-2xl p-8 shadow-lg transition-shadow overflow-hidden relative ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link
                    to="/quote-request"
                    className="inline-flex items-center px-8 py-3.5 bg-gradient-to-r from-red-600 to-blue-600 text-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 font-medium"
                >
                  Request a Quote
